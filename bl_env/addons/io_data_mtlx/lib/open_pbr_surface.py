...
from .graph_utils import apply_default_values, create_blender_node
from .node_registry import register_materialx_node


@register_materialx_node("ND_open_pbr_surface_surfaceshader")
def ND_open_pbr_surface_surfaceshader(
    tree: bpy.types.NodeTree, mx_node: mx.Node
):
    ShaderNodeBsdfPrincipled_2 = create_blender_node(
        tree, mx_node, "ShaderNodeBsdfPrincipled"
    )
    ShaderNodeBsdfPrincipled_2.update()
    ShaderNodeBsdfPrincipled_2.inputs[0].default_value = (
        0.6000000238418579,
        0.6000000238418579,
        0.6000000238418579,
        1.0,
    ...
    ShaderNodeBsdfPrincipled_2.update()
    ShaderNodeBsdfPrincipled_2.inputs[9].default_value = (
        1.0,
        0.20000000298023224,
        0.10000000149011612,
    )
    ...
    ShaderNodeBsdfPrincipled_2.update()
    ShaderNodeBsdfPrincipled_2.inputs[14].default_value = (
        1.0,
        0.0,
    ...
    ShaderNodeMix_3.update()
    ShaderNodeCombineColor_4 = create_blender_node(
        tree, mx_node, "ShaderNodeCombineColor"
    )
    ...
    ShaderNodeMix_5.update()
    ShaderNodeCombineColor_6 = create_blender_node(
        tree, mx_node, "ShaderNodeCombineColor"
    )
    ...
    ShaderNodeCombineColor_6.update()
    ShaderNodeCombineXYZ_7 = create_blender_node(
        tree, mx_node, "ShaderNodeCombineXYZ"
    )
    ...
    ShaderNodeCombineXYZ_7.update()
    ShaderNodeSeparateColor_8 = create_blender_node(
        tree, mx_node, "ShaderNodeSeparateColor"
    )
    ShaderNodeSeparateColor_8.update()
    ShaderNodeSeparateColor_8.mode = "RGB"
    ShaderNodeSeparateColor_8.update()
    ShaderNodeSeparateColor_8.inputs[0].default_value = (
        0.800000011920929,
        0.800000011920929,
        0.800000011920929,
        1.0,
    ...
    ShaderNodeMix_9.update()
    ShaderNodeCombineColor_10 = create_blender_node(
        tree, mx_node, "ShaderNodeCombineColor"
    )
    ...
    mx_node_outputs = {}
    tree.links.new(
        ShaderNodeMix_3.outputs[2], ShaderNodeBsdfPrincipled_2.inputs[0]
    )
    mx_node_outputs["out"] = ShaderNodeBsdfPrincipled_2.outputs[0]
    tree.links.new(
        ShaderNodeCombineColor_4.outputs[0], ShaderNodeMix_3.inputs[6]
    )
    mx_node_inputs["base_weight"] = ShaderNodeCombineColor_4.inputs[2]
    mx_node_inputs["base_color"] = ShaderNodeMix_3.inputs[7]
    mx_node_inputs["base_diffuse_roughness"] = (
        ShaderNodeBsdfPrincipled_2.inputs[7]
    )
    mx_node_inputs["base_metalness"] = ShaderNodeBsdfPrincipled_2.inputs[1]
    tree.links.new(
        ShaderNodeCombineColor_6.outputs[0], ShaderNodeMix_5.inputs[6]
    )
    tree.links.new(
        ShaderNodeMix_5.outputs[2], ShaderNodeBsdfPrincipled_2.inputs[14]
    )
    ...
    mx_node_inputs["specular_roughness_anisotropy"] = (
        ShaderNodeBsdfPrincipled_2.inputs[15]
    )
    mx_node_inputs["transmission_weight"] = ShaderNodeBsdfPrincipled_2.inputs[
        18
    ]
    mx_node_inputs["subsurface_weight"] = ShaderNodeBsdfPrincipled_2.inputs[8]
    tree.links.new(
        ShaderNodeSeparateColor_8.outputs[0], ShaderNodeCombineXYZ_7.inputs[0]
    )
    tree.links.new(
        ShaderNodeSeparateColor_8.outputs[1], ShaderNodeCombineXYZ_7.inputs[1]
    )
    tree.links.new(
        ShaderNodeSeparateColor_8.outputs[2], ShaderNodeCombineXYZ_7.inputs[2]
    )
    ...
    tree.links.new(
        ShaderNodeMix_9.outputs[2], ShaderNodeSeparateColor_8.inputs[0]
    )
    tree.links.new(
        ShaderNodeCombineXYZ_7.outputs[0], ShaderNodeBsdfPrincipled_2.inputs[9]
    )
    mx_node_inputs["subsurface_scatter_anisotropy"] = (
        ShaderNodeBsdfPrincipled_2.inputs[12]
    )
    ...
    tree.links.new(
        ShaderNodeCombineColor_10.outputs[0], ShaderNodeMix_11.inputs[7]
    )
    tree.links.new(
        ShaderNodeMix_11.outputs[2], ShaderNodeBsdfPrincipled_2.inputs[22]
    )
    ...
    tree.links.new(
        ShaderNodeMath_12.outputs[0], ShaderNodeBsdfPrincipled_2.inputs[29]
    )
    mx_node_inputs["thin_film_weight"] = ShaderNodeMath_12.inputs[0]
    mx_node_inputs["emission_luminance"] = ShaderNodeBsdfPrincipled_2.inputs[
        28
    ]
    ...
    mx_node_inputs["geometry_coat_normal"] = ShaderNodeBsdfPrincipled_2.inputs[
        23
    ]
    ...
    return (
        (
            ShaderNodeBsdfPrincipled_2,
            ShaderNodeMix_3,
            ShaderNodeCombineColor_4,
            ShaderNodeMix_5,
            ShaderNodeCombineColor_6,
            ShaderNodeCombineXYZ_7,
            ShaderNodeSeparateColor_8,
            ShaderNodeMix_9,
            ShaderNodeCombineColor_10,
            ShaderNodeMix_11,
            ShaderNodeMath_12,
        ),
        mx_node_inputs,
